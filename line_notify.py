...
def Get_50(key_list,first = True,run_all_day = True):
	while run_all_day:
		...
		if first:
			...
			art_url = "https://www.dcard.tw/service/api/v2/forums/nsysu/posts?limit=50&after={}".format(old_id)
		...
		for one_art in art_json:
			...
			art_urll.append("https://www.dcard.tw/f/nsysu/p/{}".format(one_art["id"]))
...
key_words = ["學生會","學生議員","機車","人行道","申訴","活動部","會長","議員","選課","初選","加簽"]
